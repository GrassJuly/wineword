package com.runjing.widget.toprightmenu;
...
//        }else {
//            holder.container.setBackgroundDrawable(addStateDrawable(mContext, -1, R.drawable.middle));
//        }
    ...
    class TRMViewHolder extends RecyclerView.ViewHolder{
        ...
        TRMViewHolder(View itemView) {
            ...
            view_line= (View) itemView.findViewById(R.id.view);
        }
    }
