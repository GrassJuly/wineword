package com.runjing.widget.pickerview.widget.wheelview;
...
import com.runjing.widget.pickerview.adapter.WheelAdapter;
import com.runjing.widget.pickerview.listener.OnItemClickedListener;
import com.runjing.widget.pickerview.listener.OnItemSelectedListener;
import com.runjing.widget.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    // 条目间距倍数
    static float lineSpacingMultiplier = 1.4F;
    boolean isLoop;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.color_a8a8a8);
        textColorCenter = getResources().getColor(R.color.color_2a2a2a);
        dividerColor = getResources().getColor(R.color.color_d5d5d5);
    ...
    void smoothScroll(ACTION action) {
        ...
        if (action == ACTION.FLING || action == ACTION.DAGGLE) {
            ...
            if (touchY > firstLineY && touchY < secondLineY)
                if (onItemClickedListener != null)
                    onItemClickedListener.onItemClicked(selectedItem);
        }
