 ...
 * SwitchButton.
 */
public class SwitchButton extends View implements SwitchCheckable {
    ...
    private SwitchState switchState = SwitchState.CALL;
    ...
    @Override
    public void setChecked(boolean checked, SwitchState state) {
    ...
    private void broadcastEvent() {
        if (onCheckedChangeListener != null) {
            ...
            onCheckedChangeListener.onCheckedChanged(this, isChecked(), switchState);
        }
...
//        void onCheckedChanged(SwitchButton view, boolean isChecked);
        void onCheckedChanged(SwitchButton view, boolean isChecked, SwitchButton.SwitchState state);
    }
...
interface SwitchCheckable extends Checkable {
    void setChecked(boolean checked, SwitchButton.SwitchState state);
}

interface SwitchCheckListener{
    void onCheckedChanged(SwitchButton view, boolean isChecked, SwitchButton.SwitchState state);
}