package com.runjing.widget.recyclerview.core;
...
import com.runjing.widget.recyclerview.drawable.SHCircleProgressBar;
...
public class SHGuidanceView extends LinearLayout {
    ...
    private void setupViews() {
        ...
        LayoutParams lp = new LayoutParams((int) DensityUtils.dip2px(getContext(), DEFAULT_CIRCLE_SIZE),
                (int) DensityUtils.dip2px(getContext(), DEFAULT_CIRCLE_SIZE));
        lp.rightMargin = (int) DensityUtils.dip2px(getContext(), 10);
