 ...
 * @author zm.
 */
public abstract class RJAdapter<T> extends BaseAdapter implements AbsListView.OnScrollListener{

  protected Collection<T> mDatas;//数据信息
  protected AbsListView mList;//listView控件
    protected boolean isScrolling;//是否在滚动
    protected Context mCxt;//上下文
    protected LayoutInflater mInflater;
    protected final int mItemLayoutId;//布局
    private AbsListView.OnScrollListener listener;
    public RJAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {
